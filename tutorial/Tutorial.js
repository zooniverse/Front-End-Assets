...
(function() {
  ...
  Tutorial.Step = (function() {
    ...
    function Step(_arg) {
      this.content = _arg.content, this.size = _arg.size, this.attach = _arg.attach, this.nextOn = _arg.nextOn, this.className = _arg.className;
    ...
    Step.prototype.enter = function(tutorial) {
      ...
      this.tutorial.message.css(this.size);
